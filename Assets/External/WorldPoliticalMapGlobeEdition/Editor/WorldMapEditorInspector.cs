		...
		public override void OnInspectorGUI () {
			...
			case OPERATION_MODE.CONFIRM:
				...
				if (_editor.countryChanges) {
					GUILayout.Label ("There're pending countries modifications.");
				}
				if (_editor.provinceChanges) {
					GUILayout.Label ("There're pending provinces modifications.");
				}
				if (_editor.cityChanges) {
					GUILayout.Label ("There're pending cities modifications.");
				}
				if (_editor.mountPointChanges) {
					GUILayout.Label ("There're pending mount points modifications.");
				}
				EditorGUILayout.Separator ();
				GUILayout.FlexibleSpace ();
				EditorGUILayout.EndHorizontal ();
