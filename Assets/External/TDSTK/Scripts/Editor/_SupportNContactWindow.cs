...
namespace TDSTK{
	...
	public class SupportNContactWindow : EditorWindow {
		...
		void OnGUI () {
			...
			EditorGUI.LabelField(new Rect(startX+spaceX, startY, width, height), "1.3.2 f3");
			EditorGUI.LabelField(new Rect(startX, startY+=spaceY, width, height), " - Release:");
			EditorGUI.LabelField(new Rect(startX+spaceX, startY, width, height), "8 September 2019");
