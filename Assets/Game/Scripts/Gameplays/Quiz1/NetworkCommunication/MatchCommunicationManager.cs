...
namespace Game.Scripts.Gameplays.Quiz1.NetworkCommunication
{
...
Debug.Log(">>>>>>>: " + messageJson);
        ...
        private async void LeaveMatch()
        {
            ...
            UnityMainThreadDispatcher.Instance().Enqueue(() =>
            {
                SceneManager.UnloadSceneAsync("Quiz1Scene");
            });
