...
namespace Game.Scripts.Configuration
{
    ...
    /// <summary>
    /// Class deriving from <see cref="DataStorage{T}"/>. Responsible for saving <see cref="Game"/>
    /// on Nakama server using the built-in storage engine.
    /// </summary>
    public class GamesStorage : DataStorage<Game>
    {
        #region Properties
        ...
        /// </summary>
        public override string StorageCollection => "configuration";
        ...
        /// </summary>
        public override string StorageKey(Game games)
        {
            return "games";
        }
